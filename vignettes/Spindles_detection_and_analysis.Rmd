...
n2_periods$idx_start = as.numeric(difftime(n2_periods$begin, s$startTime, units = "secs")) * s$sRate

n2_periods$idx_end = as.numeric(difftime(n2_periods$end, s$startTime, units = "secs")) * s$sRate - 1
