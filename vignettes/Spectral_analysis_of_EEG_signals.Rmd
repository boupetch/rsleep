...
Epoching is the first step of quantitative sleep analysis. Physiological signal, such as EEG, must be splitted into consecutive epochs of a discrete duration. Epochs usually start at the closing of lights, when the  patient or subject begins the night.
...
associated with stages in a vectorized cursor with the mapply function, peridograms of each epcoh of the whole night can be averaged by stage.
...
paeltte <-c("#F98400", "#F2AD00", "#00A08A", "#FF0000", "#5BBCD6")
