...
Cohen's Kappa score is very suitable to evaluates the model quality of predicition. Cohen's Kappa measures inter-rater reliability for qualitative @cohenCoefficientAgreementNominal1960. Originally designed for evaluation of reliability, an implementation of the Cohen's Kappa score can be found in the `psy` R package.
